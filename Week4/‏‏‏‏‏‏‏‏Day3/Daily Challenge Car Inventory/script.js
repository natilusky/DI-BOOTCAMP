...
// Part I
// 1. Create a function getCarHonda(carInventory) that takes a single parameter. carInventory‘s value is an array which is an inventory of cars
...
const honda = carInventory.filter(first => first.car_make == "Honda")
let firstHonda = honda[0]
